// Tolik Tours CRM - Main JavaScript Application

// Firebase Configuration (Version 9+ Modular SDK)
// Замените на ваши реальные конфигурационные данные Firebase
...
// Инициализация Firebase (используем старый метод для совместимости)
firebase.initializeApp(firebaseConfig);
const db = firebase.firestore();

// Расписание экскурсий по дням недели (Tolik Tours)
